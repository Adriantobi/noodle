import styles from '../../css/widgets/soundboardwidget.module.css'
import AudioComponent from './components/AudioComponent'
import Widget from '../Widget'

export default function SoundBoardWidget( { display, widgetState, defaultHeight } ) {
    return(
        <>
            <Widget title='Sounds' header='Soundboard' resize={true} widgetState={widgetState} display={display} defaultHeight={defaultHeight}>
