...
function HeaderContent() {
    ...
    return (
        <div className={styles.headerContent}>
            ...
            <span className={styles.headerText}>{`Daily Fortune | ${dateToday()}`}</span>
        </div>
    )
}

export default function FortuneWidget( { display, widgetState } ) {
    ...
    return (
        <>
            <Widget title='Fortune' header={<HeaderContent />} clear={true} widgetState={widgetState} display={display}>
