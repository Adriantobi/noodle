...
export default function SideNav( props ) {
    ...
    return (
        <div className={styles.SideNav}>
            ...
            { menuSpacesOpen ? <MenuSpaces open={menuSpacesOpen} creator={props.creatorname} space={props.spacename} link={props.link} instagram={props.instagram} youtube={props.youtube} website={props.website} twitter={props.twitter} /> : null }
        </div>
    )
}